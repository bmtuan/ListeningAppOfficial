...
//                         // sessionController.initSession(u);
//                         MenuPanel menuPanel = new MenuPanel();
//                         menuPanel.showUserInfo(u);
//                         MenuController menuController = new MenuController(menuPanel, u);
//                         MainFrame.refresh(menuPanel);
...
//                 System.out.println(UserDAO.getUser(u.getUserID()));
//                 User checkUser = UserDAO.getUser(u.getUserID());
//                 System.out.println(checkUser.getUserID() == null);
//                 if (u.isValid() && confirmPassword.equals(password) && checkUser.getUserID() == null) {
//                         UserDAO.addUser(u);
...
//             MenuPanel menuPanel = new MenuPanel();
//             MenuController menuController = new MenuController(menuPanel, null);
//             MainFrame.refresh(menuPanel);
//         }
